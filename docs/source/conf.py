# -*- coding: utf-8 -*-
#
# Open Brain Consent documentation build configuration file, created by
# sphinx-quickstart on Fri Feb 20 16:50:21 2015.
#
...
# of the sidebar.
html_logo = "_static/OBC_LogoCheck.svg"
...
htmlhelp_basename = project_compressed + 'doc'
...
man_pages = [
    ('index', project_compressed.lower(), project, [authors], 1)
]
...
#epub_basename = project_compressed.lower()
