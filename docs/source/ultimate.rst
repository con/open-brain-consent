...
Polish
~~~~~~
(translated by Marcin Koculak)

Dane i próbki z tego badania mogą zostać użyte do innych, przyszłych projektów badawczych niezależnych od badania, w którym właśnie bierzesz udział. Te przyszłe badania mogą dotyczyć dowolnego tematu, który może być niezwiązany z celami tego badania. Zapewnimy dostęp do zbieranych przez nas danych, włączając w to dane z neuroobrazowania, dla ogółu społeczeństwa za pośrednictwem internetu oraz w pełni otwartej bazy danych.

Dane udostępniane publicznie nie będą podpisane imieniem i nazwiskiem, jedynie kodem liczbowym, więc nikt nie będzie miał dostępu do Twoich danych osobowych ani nie będzie wiedział, które dane dotyczą Ciebie. Dodatkowo, nie udostępnimy jakichkolwiek informacji, co do których podejrzewamy, że mogłyby umożliwić rozpoznanie Twoich danych osobom, które Cię znają.

Jeśli zmienisz zdanie i wycofasz swoją zgodę na udział w tym badaniu (możesz to zrobić kontaktując się z <nazwisko badacza> telefonicznie: <numer telefonu> lub mailowo <adres e-mail>) nie zbierzemy od Ciebie żadnych dodatkowych danych. Skasujemy również wszelkie Twoje dane, jeśli wycofasz zgodę przed wysłaniem danych do bazy danych. **Jeśli jednak jakiekolwiek dane czy wyniki badań zostały już udostępnione innym badaczom czy ogółowi społeczeństwa ich zniszczenie, wycofanie czy anulowanie będzie niemożliwe.**

Zgadzając się na udział w badaniu, ofiarujesz bezinteresowny i hojny podarunek dla badań, które mogą pomóc innym ludziom. Istnieje możliwość, że badania przeprowadzone z wykorzystaniem danych od Ciebie doprowadzą w którymś momencie do wynalezienia nowych metod badania mózgu, nowych testów diagnostycznych, nowy leków czy innych komercyjnych produktów. Gdyby do tego doszło, nie przewiduje się możliwości uczestniczenia przez Ciebie w podziale zysków z takich produktów ani posiadania jakichkolwiek praw do takich produktów.

Zgodnie z naszą wiedzą, dane udostępniane ogółowi społeczeństwa nie będą zawierały żadnych informacji umożliwiających identyfikację Ciebie. Dane nie będą zawierać Twojego nazwiska, jedynie kod numeryczny, więc nikt nie będzie wiedział, które dane pochodzą od Ciebie. Dodatkowo, dane nie będą zawierać szczegółów, co do których podejrzewamy, że mogłyby umożliwić Twoją identyfikację przez osoby, które Cię znają, np. cechy wyglądu twarzy czy datę Twojego uczestnictwa w badaniu. Jeśli powstanie raport czy artykuł naukowy lub udostępnimy te dane innym, zrobimy to w sposób uniemożliwiający bezpośrednią identyfikację Ciebie. Możliwe jest jednak, że wykorzystanie innych danych powiązanych z Twoim imieniem i nazwiskiem (np. skanów mózgu pochodzących z Twoich danych medycznych) potencjalnie mogłoby umożliwić powiązanie informacji z naszej bazy danych z Twoją osobą. Dodatkowo, takie zdarzenia jak naruszenie zabezpieczeń (np. w wyniku cyberataku) mogłoby pozwolić powiązać Twoje dane z Twoją osobą. Ryzyko takiego zdarzenia jest jednak bardzo małe, ponieważ dane przechowywane są w zabezpieczonych bazach danych a informacje o Twojej tożsamości będą przechowywane osobno i będą połączone z danymi jedynie kodem numerycznym.

Część danych zawierających Twoje prywatne dane (imię i nazwisko, dane kontaktowe itp.) będą przechowywane w zabezpieczonym miejscu przez co najmniej 3 lata. Dzięki temu będziemy mogli się z Tobą skontaktować, jeśli badacz, który otrzymał od nas dane, znajdzie w skanach Twojego mózgu cokolwiek, co będzie posiadać wartość diagnostyczną. Po tym okresie dane zostaną zniszczone, żeby chronić Twoją prywatność.

**Zgoda na wykorzystanie przez nas Twoich danych jest dobrowolna. Jednak żeby uczestniczyć w badaniu musisz wyrazić zgodę na użycie danych w sposób opisany powyżej. Jeśli nie wyrażasz na to zgody, nie możesz wziąć udziału w badaniu.**

Podpisując poniżej wyrażasz zgodę na udostępnienie swoich danych do celów przyszłych badań. Zgadzasz się na ich udostępnienie innym badaczom i instytucjom na całym świecie. Szczegóły, wyniki czy konsekwencje tych przyszłych badań nie są obecnie znane.
