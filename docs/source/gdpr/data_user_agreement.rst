...
4. [OPTIONAL] When sharing secondary or derivative data (e.g. group statistical maps or templates), I will only do so if they are aggregate data, and information from individual participants cannot be deduced.
